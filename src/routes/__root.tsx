...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "English in Real Life" },
      ...
      { name: "twitter:title", content: "English in Real Life — Learn the English you actually use" },
      { name: "description", content: "Learn English the way you actually use it: at the restaurant, the airport, the job interview, with friends or online. Dialogues, exercises and mini-games." },
      { property: "og:description", content: "Learn English the way you actually use it: at the restaurant, the airport, the job interview, with friends or online." },
      { name: "twitter:description", content: "Learn English the way you actually use it: at the restaurant, the airport, the job interview, with friends or online." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://english-in-real-life.lovable.app",
          inLanguage: ["ro", "en"],
          description:
            "Learn English the way you actually use it: at the restaurant, the airport, the job interview, with friends or online.",
        }),
      },
    ],
  }),
